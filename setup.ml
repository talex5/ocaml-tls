...
(* OASIS_START *)
(* DO NOT EDIT (digest: 0a776a838927c2ccad0eb784ffb3a52c) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = Some "https://github.com/mirleft/ocaml-tls";
          synopsis = "TLS support for OCaml";
          description = Some [OASISText.Para "TLS support on top of OCaml"];
          categories = [];
            ...
            [
               Flag
                 ({
                   ...
                   {
                      flag_description = Some "Lwt_unix backend";
               ...
               Flag
                 ({
                   ...
                   {
                      flag_description = Some "Mirage backend";
                      flag_default = [(OASISExpr.EBool true, true)]
                   });
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage ("cstruct.unix", None)
                        ];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Tls_lwt"; "X509_lwt"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "tls";
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [InternalLibrary "tls"; InternalLibrary "tests"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
                   ...
                   {exec_custom = false; exec_main_is = "unittestrunner.ml"});
               Test
                 ({
                     cs_name = "it";
                     cs_data = PropList.Data.create ();
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "feedback.ml"});
               Executable
                 ({
                     cs_name = "starttls_server";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                      ...
                      bs_install = [(OASISExpr.EBool true, false)];
                      bs_path = "lwt/examples/";
                      bs_compiled_object = Native;
                      bs_build_depends =
                        [
                           InternalLibrary "tls-lwt";
                   ...
                   {exec_custom = false; exec_main_is = "starttls_server.ml"});
               Executable
                 ({
                     cs_name = "echo_server";
                     cs_data = PropList.Data.create ();
                  ...
                  },
                   {
                      ...
                      bs_path = "lwt/examples/";
                      bs_compiled_object = Native;
                      bs_build_depends = [InternalLibrary "tls-lwt"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
                   ...
                   {exec_custom = false; exec_main_is = "echo_server.ml"});
               Executable
                 ({
                     cs_name = "echo_server_sni";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {exec_custom = false; exec_main_is = "echo_server_sni.ml"});
               Executable
                 ({
                     cs_name = "echo_client";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "echo_client.ml"});
               Executable
                 ({
                     cs_name = "http_client";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "http_client.ml"});
               Executable
                 ({
                     cs_name = "test_server";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "test_server.ml"});
               Executable
                 ({
                     cs_name = "test_client";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "test_client.ml"});
               Doc
                 ({
                     cs_name = "api";
                     cs_data = PropList.Data.create ();
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "\184\145=b\127C;\163'J\014s\201\209K\246";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
